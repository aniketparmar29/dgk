...
<body>
  ...
  <div class="text-white font-semibold  p-2 h-15 w-full" style="background-color: rgb(101 163 13);" > Welcome to our Organic store jay ho village!</div>
  
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 py-8 text-lg">
