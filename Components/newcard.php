  ...
  <div class="container mx-auto p-4">
    <div class="grid grid-cols-2 gap-4">
      <div class="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
        <img src="card1.jpg" alt="Card 1" class="w-full">
        <div class="p-4">
      ...
      <div class="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
        <img src="card2.jpg" alt="Card 2" class="w-full">
        <div class="p-4">
      ...
      <div class="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
        <img src="card3.jpg" alt="Card 3" class="w-full">
        <div class="p-4">
      ...
      <div class="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
        <img src="card4.jpg" alt="Card 4" class="w-full">
        <div class="p-4">
